...
| File | Purpose |
|---|---|
| `CONTENT-GUIDELINES.md` | Legal compliance (ACL), pricing rules, medical content restrictions, voice/tone |
| `BUILD-RULES.md` | Architecture pattern, deployment config, content collection standard, image generation workflow |
| `INTERLINK-RULES.md` | Cross-site and internal linking system, anchor text rules, frontmatter requirements |
